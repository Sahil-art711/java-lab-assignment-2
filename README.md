...
📘 Overview This project implements a Student Management System in Java using the core Object-Oriented Programming (OOP) principles:
...
🧠 Objective To design and implement a Student Management System that demonstrates:

1.The use of inheritance between classes.
2.The application of abstract classes and interfaces.
3.Polymorphism through method overriding and overloading.
4.Prevention of duplicate student records using data structures.
🏗️ Class Hierarchy
